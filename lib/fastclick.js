;(function () {
	...
	*/
	...
	FastClick.prototype.noPrevent = function(target) {
		return /\bnoPrevent\b/.test(target.className);
	}
	...
	FastClick.prototype.onTouchEnd = function(event) {
		...
		if (!this.needsClick(targetElement)) {
			// Sometimes, don't want to prevent behavior. e.g <input readonly /> setup it
			if (!this.noPrevent(targetElement)){
				event.preventDefault();
			}
			this.sendClick(targetElement, event);
		}
